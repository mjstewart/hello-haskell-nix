...
/* package hello-haskell-nix-0.1.0.0 */
#ifndef VERSION_hello_haskell_nix
#define VERSION_hello_haskell_nix "0.1.0.0"
#endif /* VERSION_hello_haskell_nix */
#ifndef MIN_VERSION_hello_haskell_nix
#define MIN_VERSION_hello_haskell_nix(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hello_haskell_nix */
...
#define CURRENT_COMPONENT_ID "hello-haskell-nix-0.1.0.0-inplace-hello-haskell-nix"
